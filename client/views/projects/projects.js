...
var ProjectsListItems = function(cursor) {
	...
	if(!searchString || searchString == "") {
		...
		var searchFields = ["pj_name", "customerid", "pj_start_date", "pj_due_date", "pj_priority", "pj_brief", "pj_description", "pj_skills", "pj_type", "pj_task_count", "pj_tasks_complete", "pj_tasks_pending", "pj_budget"];
...
var ProjectsListExport = function(cursor, fileType) {
	...
	var exportFields = ["pj_name", "pj_start_date", "pj_due_date", "pj_priority", "pj_brief", "pj_description", "pj_skills", "pj_type", "pj_task_count", "pj_tasks_complete", "pj_tasks_pending", "pj_budget"];
...
Template.ProjectsListTableItems.events({
	...
	"click #edit-button": function(e, t) {
		e.preventDefault();
		Router.go("projects.edit", {customerId: this._id});
		return false;
	}
});
