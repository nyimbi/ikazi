...
Template.CustomersEditForm.rendered = function() {
	...
	"submit": function(e, t) {
		...
		validateForm(
			...
			function(values) {
				...
				Customers.update({ _id: t.data.customers_selected._id }, { $set: values }, function(e) { if(e) errorAction(e); else submitAction(); });
			}
		);
